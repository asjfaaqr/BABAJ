...
How to use the map:
1. Open the `ship_samples_lat_lon.xlsx` file or input any coordinates  
...
This prototype aims to simplify the visualization of environmental data linked to specific sampling points, 
making it easier to analyze patterns and insights from collected samples. If you encounter any issues, please review the instructions or ensure your live server is correctly set up.

please note that this not a completed prototype